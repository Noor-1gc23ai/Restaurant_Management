    ...
    <GlassCard className="p-0 border-white/5">
      <div className="flex flex-col gap-4 p-4 md:flex-row md:items-center md:gap-6 md:p-5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h4 className="truncate font-serif text-xl text-white md:text-2xl">
            {item.name}
          </h4>
        ...
        <div className="flex flex-wrap items-center gap-3 md:justify-end">
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/20 text-white transition-colors hover:bg-primary/30"
          ...
          <div className="min-w-28 text-right">
            ...
            <p className="text-lg font-serif text-white">{formatPrice(itemSubtotal)}</p>
          </div>

          <button
            type="button"
            onClick={() => removeItem(item.id)}
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-slate-500 transition-colors hover:border-red-500/30 hover:text-red-400"
